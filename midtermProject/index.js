        ...
        <div class="col">
            <div class="card shadow-sm" id="cards" style="background-color: lightgrey;">
                ...
                <div class="card-body" id="cardtoo">
                    ...
                    <div id="smaller" style="display: none"><p><Strong> Description: </Strong> ${disc}<br><Strong> <span style="font-size: 20px;">Price: </span></Strong> <span style="font-size: 20px;">$${price}</span> <br> <a href="${url}" class="btn btn-sm btn-outline-secondary">View</a> </p></div>
                </div>
            </div>
        </div>`;
